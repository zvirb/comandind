#!/usr/bin/env python3
"""
Import health check script for API service.
...
def check_critical_imports():
    """Test critical imports that the API service depends on."""
    import_tests = [
        ...
        ("shared.services.enhanced_jwt_service", "JWT service"),
        ("shared.monitoring.prometheus_metrics", "Prometheus metrics"),
        ("shared.services.auth_middleware_service", "Authentication middleware"),
        ("api.dependencies", "API dependencies"),
        ("api.routers.chat_router", "Chat router"),
        ("api.routers.auth_compatibility", "Auth compatibility"),
    ]
...
if __name__ == "__main__":
    ...
    print("API Service Import Health Check")
    print("=" * 40)
    ...
    with open("/tmp/api_import_health_evidence.json", "w") as f:
