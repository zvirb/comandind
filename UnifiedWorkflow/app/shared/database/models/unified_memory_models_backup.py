...
class ChatModeSession(Base):
    ...
    # memory_vectors = relationship("UnifiedMemoryVector", back_populates="session")  # DISABLED
...
# TEMPORARILY REMOVED: UnifiedMemoryVector class to isolate metadata conflict
